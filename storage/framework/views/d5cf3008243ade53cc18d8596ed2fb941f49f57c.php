        ...
        <div class="form-group">
            ...
            <select class="custom-select" name="chapter_id">
                ...
                <?php if(!empty($chapters)): ?>
                    <?php $__currentLoopData = $chapters->where('type',\App\Models\WebinarChapter::$chapterTextLesson); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/webinars/modals/testLesson.blade.php ENDPATH**/ ?>