...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <button type="submit" style="background-color: #45aa52;
                            border-color: #45aa52;color:#fff;" class="btn btn-lg btn-block" tabindex="4">
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">YouSeed LMS</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved for <a style="border-bottom: 1px solid #46aa52!important;" class="text-light bb" target="_blank" href="https://youseed.com.my">YouSeed</a>
            </div>
          </div>
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>