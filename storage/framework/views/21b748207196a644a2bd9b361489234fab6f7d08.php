    ...
    <section id="floating">
        ...
        <section id="parent_feedback" style="padding: 50px 0px">
            <div class="container" style="position: relative">
                ...
                <div style="position: relative;">
                    <h3 style="font-weight: bold;margin-bottom: 40px;text-align:center;font-size: 26px;"><?php echo e(trans('home.parent_feedback')); ?>
...
<?php echo $__env->make(getTemplate() . '.layouts.app_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/admin/Code/lms/resources/views/web/default/pages/home_new.blade.php ENDPATH**/ ?>