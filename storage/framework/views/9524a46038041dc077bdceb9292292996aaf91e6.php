...
<?php $__env->startSection('content'); ?>
    ...
    <form method="post" id="userSettingForm" style="padding: 20px 50px;" class="mt-30"
    ...
    <div style="padding: 20px 50px;" class="create-webinar-footer d-flex align-items-center justify-content-between mt-20 pt-15 border-top">
        <div class="">
            <?php if(!empty($user)): ?>
                ...
                <button type="button" id="getNextStep" class="btn btn-sm btn-primary ml-15"
                    <?php if(!empty($currentStep) and ($user->isUser() and $currentStep == 2 or !$user->isUser() and $currentStep == 2)): ?> disabled <?php endif; ?>><?php echo e(trans('webinars.next')); ?></button>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/panel/setting/index.blade.php ENDPATH**/ ?>