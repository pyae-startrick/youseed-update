        ...
        <div class="create-webinar-footer d-flex flex-column flex-md-row align-items-center justify-content-between mt-20 pt-15 border-top">
            <div class="d-flex align-items-center">
                ...
                <?php if(!empty($webinar)): ?>
                    <a href="/panel/webinars/<?php echo e($webinar->id); ?>/step/<?php echo e(($currentStep - 3)); ?>" class="btn btn-sm btn-primary <?php echo e($currentStep < 5 ? 'disabled' : ''); ?>"><?php echo e(trans('webinars.previous')); ?></a>
                <?php else: ?>
                    <a href="" class="btn btn-sm btn-primary disabled"><?php echo e(trans('webinars.previous')); ?></a>
                <?php endif; ?>

                <button type="button" id="getNextStep" class="btn btn-sm btn-primary ml-15" <?php if($currentStep >= 4): ?>  disabled <?php endif; ?>>
                    <?php echo e(trans('webinars.next')); ?></button>
            </div>
            <?php if($currentStep == 4): ?>

            <div class="mt-20 mt-md-0">
                <button type="button" id="sendForReview" class="btn btn-sm btn-primary">Save File</button>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/panel/webinar/create.blade.php ENDPATH**/ ?>