                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="socials-tab" data-toggle="tab" href="#features" role="tab" aria-controls="features" aria-selected="true"><?php echo e(trans('update.features')); ?></a>
                                </li>
                            </ul>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/settings/general.blade.php ENDPATH**/ ?>