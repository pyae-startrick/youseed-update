...
<nav id="navbar" class="navbar navbar-expand-lg"
    ...
    <div class="<?php echo e((!empty($isPanel) and $isPanel) ? 'container-fluid' : ''); ?>" style="width: 100%!important">
                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center m-auto font-weight-bold">
                    ...
                    <li class="nav-item hide-desktop">
                        <a id="navbarClose" class="nav-link"
                            style="color: #46AA52;font-size: 13px;"href="https://shop.youseed.com.my" target="_blank"><?php echo e(trans('home.shop')); ?></a>
                    </li>
                    
                    <?php if(!empty($authUser)): ?>
                        <li class="nav-item hide-desktop">
                            <a id="navbarClose" class="nav-link" href="<?php echo e($authUser->isAdmin() ? '/admin' : '/panel'); ?>"
                                style="color: #46AA52;font-size: 13px;"><?php echo e(trans('home.my_panel')); ?></a>
                        </li>
                        
                        <li class="nav-item hide-desktop">
                            <a id="navbarClose" class="nav-link" href="/logout"
                                style="color: #46AA52;font-size: 13px;"><?php echo e(trans('home.log_out')); ?></a>
                        </li>

                    <?php else: ?>
                        <li class="nav-item hide-desktop">
                            <a id="navbarClose" class="nav-link" href="/login"
                                style="color: #46AA52;font-size: 13px;"><?php echo e(trans('home.login')); ?></a>
                        </li>
                        <li class="nav-item hide-desktop">
                            <a id="navbarClose" class="nav-link" href="/register"
                                style="color: #46AA52;font-size: 13px;"><?php echo e(trans('home.register')); ?></a>
                        </li>
                    <?php endif; ?>
                                    ...
                                    <?php if(!empty($authUser)): ?>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item"
                                                ...
                                                <span
                                                    class="font-14 text-dark-blue"><?php echo e(trans('home.my_panel')); ?></span>
                                            </a>
                                            
                                            <a class="dropdown-item" href="/logout">
                                                <span
                                                    class="font-14 text-dark-blue"><?php echo e(trans('home.log_out')); ?></span>
                                            </a>
                                        </div>
                                </div>
                            <?php else: ?>
                                <div class="align-items-center dropdown">
                                    <a href="/login"
                                        class="dropdown-item py-5 px-10 mr-10 text-dark-blue font-14"><?php echo e(trans('home.login')); ?></a>
                                    <a href="/register"
                                        class="dropdown-item py-5 px-10 text-dark-blue font-14"><?php echo e(trans('home.register')); ?></a>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/admin/Code/lms/resources/views/web/default/includes/navbar_new.blade.php ENDPATH**/ ?>