                                ...
                                <div class="d-flex align-items-center justify-content-between mt-20">
                                    ...
                                    <div class="">
                                        <?php if(!empty($user) and $quiz->can_download_certificate and $hasBought): ?>
                                            <a href="/panel/quizzes/results/<?php echo e($quiz->result->id); ?>/downloadCertificate" class="course-content-btns btn btn-sm btn-primary"><?php echo e(trans('home.download')); ?></a>
                                        <?php else: ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/course/tabs/contents/certificate.blade.php ENDPATH**/ ?>