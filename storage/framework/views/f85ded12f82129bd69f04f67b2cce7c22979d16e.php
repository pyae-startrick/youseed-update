<div class="row">
    <div class="col-12">
        <div class="accordion-content-wrapper" id="quizzesAccordion<?php echo e(!empty($tagId)); ?>" role="tablist" aria-multiselectable="true">
            <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="accordion-row rounded-sm border mt-20 p-15">
                    <div class="d-flex align-items-center justify-content-between" role="tab" id="quiz_<?php echo e($quiz->id); ?>">
                        <div class="d-flex align-items-center" href="#collapseQuiz<?php echo e(!empty($tagId)); ?><?php echo e($quiz->id); ?>" aria-controls="collapseQuiz<?php echo e(!empty($tagId)); ?><?php echo e($quiz->id); ?>" data-parent="#quizzesAccordion<?php echo e(!empty($tagId)); ?>" role="button" data-toggle="collapse" aria-expanded="true">
                        ...
                        <i class="collapse-chevron-icon" data-feather="chevron-down" height="20" href="#collapseQuiz<?php echo e(!empty($tagId)); ?><?php echo e(!empty($quiz) ? $quiz->id :'record'); ?>" aria-controls="collapseQuiz<?php echo e(!empty($tagId)); ?><?php echo e(!empty($quiz) ? $quiz->id :'record'); ?>" data-parent="#quizzesAccordion<?php echo e(!empty($tagId)); ?>" role="button" data-toggle="collapse" aria-expanded="true"></i>
                    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/course/tabs/contents/quiz.blade.php ENDPATH**/ ?>