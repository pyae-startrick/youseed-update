...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(!empty($findInstructorSection)): ?>
                    ...
                    <div class="position-relative ">
                        ...
                        <div class="example-instructor-card bg-white rounded-sm shadow-lg  p-5 p-md-15 d-flex align-items-center">
                            <div class="example-instructor-card-avatar">
                                <img src="<?php echo e(getPageBackgroundSettings('user_avatar')); ?>" class="img-cover rounded-circle" alt="user name">
                            </div>
    ...
    <?php if(!empty($rewardProgramSection)): ?>
    ...
    <?php if(!empty($becomeInstructorSection)): ?>
        <section class="home-sections home-sections-swiper container find-instructor-section position-relative">
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="">
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>