...
unset($__errorArgs, $__bag); ?>"
                                                id="email" value="<?php echo e(old('email')); ?>" aria-describedby="emailHelp">
                                                ...
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(old('role_id')): ?>
                                                        <option value="<?php echo e($role->id); ?>"
                                                            <?php echo e(old('role_id') ? 'selected' : ''); ?>>
                                                            <?php echo e($role->name); ?>  - <?php echo e($role->caption); ?></option>
                                                    <?php else: ?>
                                                        <option value="<?php echo e($role->id); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group d-none" id="groupSelect">
                                            ...
                                            <select name="group_id"
                                                class="form-control select2 <?php $__errorArgs = ['group_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <?php $__currentLoopData = $userGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($userGroup->id); ?>"
                                                        <?php if(!empty($notification) and !empty($notification->group) and $notification->group->id == $userGroup->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = \App\User::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($status); ?>"
                                                        <?php echo e(old('status') === $status ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/users/create.blade.php ENDPATH**/ ?>