    ...
    <div class="<?php echo e((!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container'); ?>">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="nav-icons-or-start-live navbar-order">
                ...
                <a href="<?php echo e(empty($authUser) ? '/login' : ($authUser->isAdmin() ? '/admin/webinars/create' : (($authUser->isUser()) ? '/become-instructor' : '/panel/webinars/new'))); ?>" class="d-none d-lg-flex btn btn-sm btn-primary nav-start-a-live-btn">
                ...
                <a href="<?php echo e(empty($authUser) ? '/login' : (($authUser->isUser()) ? '/become-instructor' : '/panel/webinars/new')); ?>" class="d-flex d-lg-none text-primary nav-start-a-live-btn font-14">
                    <?php echo e((empty($authUser) or !$authUser->isUser()) ? trans('navbar.start_a_live_class') : ($authUser->isUser() ? trans('site.become_instructor') : '')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/admin/domains/subs/app/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>