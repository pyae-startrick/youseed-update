                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            <?php if($cart->webinar->getDiscount($cart->ticket) > 0): ?>
                                                <span class="text-primary font-weight-bold"><?php echo e(handlePrice($cart->webinar->price - $cart->webinar->getDiscount($cart->ticket))); ?></span>
                                                <span class="off ml-15"><?php echo e(handlePrice($cart->webinar->price)); ?></span>
                                            <?php else: ?>
                                                <span class="text-primary font-weight-bold"><?php echo e(handlePrice($cart->webinar->price)); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            <span class="text-primary font-weight-bold">
                                                <?php if(!empty($cart->reserve_meeting_id)): ?>
                                                    <?php echo e(handlePrice($cart->reserveMeeting->meeting->amount)); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/includes/shopping-cart-dropdwon.blade.php ENDPATH**/ ?>