            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(addCurrencyToPrice(round($registrationBonus, 2))); ?></strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(addCurrencyToPrice(round($affiliateBonus, 2))); ?></strong>
    ...
    <section class="mt-25">
        ...
        <?php if(!empty($referralSettings)): ?>
            <div class="mt-15 font-14 text-gray">
                <?php if(!empty($referralSettings['affiliate_user_amount'])): ?><p>- <?php echo e(trans('panel.user_registration_reward')); ?>: <?php echo e(addCurrencyToPrice($referralSettings['affiliate_user_amount'])); ?></p><?php endif; ?>
                <?php if(!empty($referralSettings['referred_user_amount'])): ?><p>- <?php echo e(trans('panel.referred_user_registration_reward')); ?>: <?php echo e(addCurrencyToPrice($referralSettings['referred_user_amount'])); ?></p><?php endif; ?>
                        ...
                        <table class="table text-center custom-table">
                            ...
                            <?php $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(addCurrencyToPrice($affiliate->getAffiliateRegistrationAmountsOfEachReferral())); ?></td>

                                    <td><?php echo e(addCurrencyToPrice($affiliate->getTotalAffiliateCommissionOfEachReferral())); ?></td>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/panel/marketing/affiliates.blade.php ENDPATH**/ ?>