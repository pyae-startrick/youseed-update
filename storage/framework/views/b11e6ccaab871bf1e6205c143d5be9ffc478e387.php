<div class="stars-card d-flex align-items-center <?php echo e($className ?? ' mt-15'); ?>">
    ...
    <?php if(empty($dontShowRate) or !$dontShowRate): ?>
        <span class="badge ml-10" style="background-color:#46aa52;color:#fff;"><?php echo e($rate); ?></span>
    <?php endif; ?>

</div>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/includes/webinar/rate.blade.php ENDPATH**/ ?>