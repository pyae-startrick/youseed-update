<div id="chapterModalHtml" class="d-none">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">New Session</h2>
        ...
        <div class="js-content-form chapter-form mt-20" data-action="/panel/chapters/store">
            ...
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent " style="display: block!important">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/panel/webinar/create_includes/chapter_modal.blade.php ENDPATH**/ ?>