                ...
                <div class="mt-30 row align-items-center">
                        ...
                        <?php if(auth()->check()): ?>
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" name="read" class="custom-control-input" id="readLessonSwitch" data-course-id="<?php echo e($course->id); ?>" data-lesson-id="<?php echo e($textLesson->id); ?>" <?php echo e(!empty($textLesson->learningStatus) ? 'checked' : ''); ?>>
                    ...
                    <div class="col-12 col-md-7 text-right">
                        <?php if(!empty($course->textLessons) and count($course->textLessons)): ?>
                            ...
                            <a href="<?php echo e((!empty($nextLesson)) ? $course->getUrl() .'/lessons/'. $nextLesson->id .'/read' : '#'); ?>" class="btn btn-sm <?php echo e((!empty($nextLesson)) ? 'btn-primary' : 'btn-gray disabled'); ?>"><?php echo e(trans('public.next_lesson')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="p-0 m-0 pt-10">
                            <?php $__currentLoopData = $textLesson->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mt-10 p-10 rounded bg-info-lighter font-14 font-weight-500 text-dark-blue d-flex align-items-center justify-content-between text-ellipsis">
                                    ...
                                    <a href="<?php echo e($course->getUrl()); ?>/file/<?php echo e($attachment->file->id); ?>/download">
                        ...
                        <div class="p-0 m-0 pt-10">
                            <?php $__currentLoopData = $course->textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($course->getUrl()); ?>/lessons/<?php echo e($lesson->id); ?>/read"
                                   class="d-block mt-10 px-10 py-15 rounded font-14 font-weight-500 text-ellipsis <?php if($lesson->id == $textLesson->id): ?> bg-primary text-white <?php else: ?> bg-info-lighter text-dark-blue <?php endif; ?>">
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/subs/app/resources/views/web/default/course/text_lesson.blade.php ENDPATH**/ ?>