        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/admin/quizzes/<?php echo e($quiz->id); ?>/update" id="webinarForm" class="webinar-form">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    ...
                                                    <p>Teacher: <?php echo e($creator->full_name); ?></p>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/quizzes/edit.blade.php ENDPATH**/ ?>