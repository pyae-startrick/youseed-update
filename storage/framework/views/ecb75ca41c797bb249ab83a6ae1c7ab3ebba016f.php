...
<?php $__env->startSection('content'); ?>
    ...
    <section class="container course-content-section <?php echo e($course->type); ?>">
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="course-content-body user-select-none">
                    ...
                    <div class="<?php if(!$course->isCourse()): ?> mt-35 <?php else: ?> mt-20 pt-20  mt-md-40 pt-md-40  <?php endif; ?>">
                                ...
                                <?php elseif($course->price > 0): ?>
                                    ...
                                    <?php if($canSale and !empty($course->points)): ?>
                                        <a href="<?php echo e(!(auth()->check()) ? '/login' : '#'); ?>" class="<?php echo e((auth()->check()) ? 'js-buy-with-point' : ''); ?> btn btn-outline-warning mt-20 <?php echo e((!$canSale) ? 'disabled' : ''); ?>" rel="nofollow">
                                            <?php echo e(trans('update.buy_with_n_points',['points' => $course->points])); ?>

                                        </a>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a href="<?php echo e('/course/'. $course->slug .'/free'); ?>" class="btn btn-primary"><?php echo e(trans('public.enroll_on_webinar')); ?></a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>