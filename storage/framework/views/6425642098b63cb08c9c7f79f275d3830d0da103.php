...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($user->role_name == 'teacher'): ?>
                    <div class="form-group mt-15 ">
                        <label class="input-label d-block">Assign an Students (<span style="color: gray;">To remove selected student need to go <a href="/admin/assigned-students" target="_blank">Teacher's Student List</a> Page </span>)</label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/admin/Code/lms/resources/views/admin/users/editTabs/general.blade.php ENDPATH**/ ?>