                ...
                <div class="card-header">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_agora_history_export')): ?>
                        <div class="text-right">
                            <a href="/admin/agora_history/excel" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped text-center font-14">
                            ...
                            <?php $__currentLoopData = $agoraHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agoraHistory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td class="text-left"><?php echo e($agoraHistory->session->webinar->title); ?></td>
                                    <td class="text-left"><?php echo e($agoraHistory->session->title); ?></td>
                                    <td><?php echo e(convertMinutesToHourAndMinute($agoraHistory->session->duration)); ?></td>
                                    ...
                                    <td class="<?php echo e(($meetingDuration > $agoraHistory->session->duration) ? 'text-danger' : 'text-success'); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/admin/agora_history/index.blade.php ENDPATH**/ ?>