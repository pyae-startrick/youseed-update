...
<?php $__env->startSection('content'); ?>
    ...
    <section class="mt-35" style="padding: 20px 50px;">
                                ...
                                <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-right font-weight-normal">
                                            ...
                                            <a style="background-color: #46aa52;
                                            color: #fff;
                                            padding: 12px;
                                            border-radius: 15px;
                                            width: fit-content;
                                            float: right;" href="/panel/quizzes/<?php echo e($quiz->id); ?>/start" target="_blank" class="webinar-actions d-block mt-10">Take Quiz</a>
    ...
    <div class="my-30" style="padding: 20px 50px;">
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/lms/resources/views/web/default/panel/quizzes/opens.blade.php ENDPATH**/ ?>