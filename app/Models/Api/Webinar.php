    ...
    public function getDetailsAttribute()
    {
        ...
        $details = [
            ...
            'session_chapters' => $this->chapters()
                ...
                ->where('type', WebinarChapter::$chapterSession)
                ->orderBy('order', 'asc')
                ->get()
            ...
            'text_lesson_chapters' => $this->chapters()
                ->where('status', WebinarChapter::$chapterActive)
                ->where('type', WebinarChapter::$chapterTextLesson)->get()
                ->map(function ($chapter) {
                    return $chapter->details;
                }),
            ...
            'text_lessons_count' => $this->chapters()
                ->where('type', WebinarChapter::$chapterTextLesson)->count(),
            ...
            'can_buy_with_points' => ($this->canSale() and !$this->checkUserHasBought($user) and !empty($this->points)),
            //////********************
        ];
