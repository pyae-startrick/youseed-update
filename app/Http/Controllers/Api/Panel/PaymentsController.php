...
class PaymentsController extends Controller
{
    ...
    public function apiPaymentRequest(Request $request){
      ...
      $discount_id=$request->input('discount_id') ;
        ...
        return view('api.payment_request',compact('discount_id')) ;
    }
    ...
    public function webCharge(Request $request){

     //   Auth::login(apiAuth()->user()) ;


        return apiResponse2(1, 'generated', trans('api.link.generated'),
    [
        'link'=> URL::signedRoute('api.charge.request',['user_id'=>apiAuth()->id])
    ]
    );

    }

    public function apiChargeRequest(Request $request){
