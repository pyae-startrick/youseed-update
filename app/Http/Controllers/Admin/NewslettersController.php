...
class NewslettersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // }
        if (!empty($data)) {
            \Mail::to('youseededucation@gmail.com')->send(new ContactForm($contact));
        }
        Newsletter::create([
            'name' => $name,
            'age' => $age,
        ...
        $sweetAlertData = [
            'msg' => trans('home.newsletter_sent_success'),
            'status' => 'success'
        ];
        return response()->json(['sweetalert' => $sweetAlertData]);
        // return redirect('/congratulation')->with($sweetAlertData);
    }
