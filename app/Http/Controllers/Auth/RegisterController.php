...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showSignUpforTest()
    {
        $pageTitle = 'Signup For Test';
        $data = [
            'pageTitle' => $pageTitle,
        ];
        return view(getTemplate() . '.auth.sign_up_for_test', $data);
    }
    ...
    protected function validator(array $data)
    {
        ...
        return Validator::make($data, [
            ...
            // $username => (!empty($username)) ? 'required|string|email|max:255' : '',
            'term' => 'required',
