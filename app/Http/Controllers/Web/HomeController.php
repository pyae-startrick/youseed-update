...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view(getTemplate() . '.pages.home_new', $data);
    }
    public function congra()
    {
        // $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : trans('home.home_title');
        ...
        return view(getTemplate() . '.pages.test_congra', $data);
    }
    public function policy()
    {
        $pageTitle = 'Provacy & Policy';

        $data = [
            'pageTitle' => $pageTitle
        ];

        return view(getTemplate() . '.pages.policy', $data);
    }
    public function term()
    {
        ...
        return view(getTemplate() . '.pages.term', $data);
    }
    public function cancellation()
    {
        ...
        return view(getTemplate() . '.pages.cancellation', $data);
    }
}
