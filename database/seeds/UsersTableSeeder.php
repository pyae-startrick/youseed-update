...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        \App\User::updateOrCreate(['id' => 1], ['full_name' => 'admin', 'mobile' => '09379332830','role_name' => 'admin', 'email' => 'admin@demo.com', 'role_id' => 2, 'password' => password_hash('admin', PASSWORD_BCRYPT),'status' => 'active','created_at' => '1597826952','updated_at' => '1597826952']);
