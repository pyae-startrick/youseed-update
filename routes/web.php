...
Route::get('/my_api/payment/request', 'Api\Panel\PaymentsController@apiPaymentRequest')->name('api.payment.request');
Route::get('/my_api/charge/request', 'Api\Panel\PaymentsController@apiChargeRequest')->name('api.charge.request');
Route::get('/my_api/subscribe/request', 'Api\Panel\SubscribesController@apiSubscribeRequest')->name('api.subscribe.request');
Route::get('/my_api/registration_packages/request', 'Api\Panel\RegistrationPackagesController@apiPaymentRequest')->name('api.registration_packages.request');
Route::post('/sendnewsletters', 'Admin\NewslettersController@store')->name('sendnewsletters');
...
Route::group(['namespace' => 'Auth', 'middleware' => ['share']], function () {
    ...
    Route::get('/sign-up-for-test', 'RegisterController@showSignUpforTest');
...
Route::group(['namespace' => 'Web', 'middleware' => ['impersonate', 'share']], function () {
    ...
    Route::get('/congratulation', 'HomeController@congra');
    Route::get('/privacy-policy', 'HomeController@policy');
    Route::get('/term-condition', 'HomeController@term');
    Route::get('/cancellation', 'HomeController@cancellation');
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::get('/learning/record/{id}/delete', 'LearningPageController@deleteRecording');
    });
