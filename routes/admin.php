...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'assigned-students'], function () {
            Route::get('/', 'UserController@assignedStudents');
            Route::get('/{id}/delete', 'UserController@assignedStudentsDelete');
            Route::post('/studentmultiassigndelete', 'UserController@deleteMultipleAssignStudent');
        });
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/student', 'WebinarController@student');
            Route::get('/records', 'WebinarController@record');
            Route::get('/student/{id}/delete', 'WebinarController@deleteStudent');
            Route::post('/studentmultidelete', 'WebinarController@deleteMultipleStudent');
            Route::get('/record/{id}/delete', 'WebinarController@deleteRecord');
            Route::post('/recordmultidelete', 'WebinarController@deleteMultipleRecord');
            ...
            Route::post('/classmultidelete', 'WebinarController@deleteMultipleClass');
