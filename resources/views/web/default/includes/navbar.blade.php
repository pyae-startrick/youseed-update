    ...
    <div class="{{ (!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container' }}">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="nav-icons-or-start-live navbar-order">
                ...
                <a href="{{ empty($authUser) ? '/login' : ($authUser->isAdmin() ? '/admin/webinars/create' : ($authUser->isUser() ? '/become-instructor' : '/panel/webinars/new')) }}"
                ...
                <a href="{{ empty($authUser) ? '/login' : ($authUser->isUser() ? '/become-instructor' : '/panel/webinars/new') }}"
