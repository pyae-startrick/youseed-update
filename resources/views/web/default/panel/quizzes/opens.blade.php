                                        ...
                                        <td class="align-middle text-right font-weight-normal">
                                            {{-- <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/panel/quizzes/{{ $quiz->id }}/start" class="webinar-actions d-block mt-10">Start Quiz</a>
                                            ...
                                            border-radius: 15px;
                                            width: fit-content;
                                            float: right;" href="/panel/quizzes/{{ $quiz->id }}/start" target="_blank" class="webinar-actions d-block mt-10">Take Quiz</a>
