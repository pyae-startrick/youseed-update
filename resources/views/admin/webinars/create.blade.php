...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ !empty($webinar) ? $pageTitle : $pageTitle }}
            </h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ !empty($webinar) ? 'Edit Online Class' : 'New Online Class' }}
                </div>
            </div>
        </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post"
                                action="/admin/webinars/{{ !empty($webinar) ? $webinar->id . '/update' : 'store' }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-none">{{ trans('panel.course_type') }}</label>

                                                <select name="type"
                                                    class="custom-select @error('type') is-invalid @enderror" hidden>
                                                    <option value="webinar" selected>{{ trans('webinars.webinar') }}
                                                    </option>
                                            ...
                                            <div
                                                class="form-group mt-15 @if (empty($webinar)) d-block @else d-none @endif ">
                                                ...
                                                <select name="teacher_id"
                                                    ...
                                                    @foreach ($teachers as $teacher)
                                                        @if (old('teacher_id'))
                                                            <option value="{{ old('teacher_id') }}"
                                                                {{ $teacher->id == old('teacher_id') ? 'selected' : '' }}>
                                                                {{ $teacher->full_name }}</option>
                                                        @else
                                                            <option value="{{ $teacher->id }}"
                                                                @if (!empty($webinar) and $webinar->teacher_id == $teacher->id) selected @endif>
                                                                {{ $teacher->full_name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                    ...
                                                    @foreach ($students as $student)
                                                        @if (old('student'))
                                                            <option value="{{ $student->id }}"
                                                                ...
                                                                [{{ $student->id }}] {{ $student->full_name }} </option>
                                                        @else
                                                            @if (!empty($webinar))
                                                                <option value="{{ $student->id }}" <?php foreach ($sales as $sale) {
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mt-15">
                                                ...
                                                <textarea name="description" rows="5" class="form-control @error('description') is-invalid @enderror"
                                                    placeholder="Maximum 300 words.">{!! !empty($webinar) ? $webinar->description : old('description') !!}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <section class="mt-3">
                                    <h2 class="section-title after-line">{{ trans('public.additional_information') }}
                                    </h2>
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div id="partnerInstructorInput"
                                                ...
                                                <select name="partners[]" class="form-control select2" multiple=""
                                                    ...
                                                    @foreach ($teachers as $teacher)
                                                        <option value="{{ $teacher->id }}"
                                                            {{ !empty($webinar) && isset($webinarPartnerTeacher[$teacher->id]) ? 'selected' : '' }}>
                                                            {{ $teacher->full_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <select id="categories"
                                                    ...
                                                    <option {{ !empty($webinar) ? '' : 'selected' }} disabled>Select
                                                        Subject</option>
                                ...
                                @if (!empty($webinar))
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach ($chapters as $chapter)
                                                                <tr>
                                                                    ...
                                                                    <th>{{ trans('admin/main.' . $chapter->status) }}
                                                                    </th>
                                    ...
                                    @if (!empty($webinar) && $webinar->isWebinar())
                                                            ...
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                @foreach ($sessions as $session)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ dateTimeFormat($session->date, 'j F Y | H:i', true, false, $webinar->timezone) }}
                                                                        </td>
                                                                        <td>{{ $session->duration }}
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="px-2 mt-3">
                                                <button id="webinarAddFile" type="button"
                                                    class="btn btn-primary btn-sm">{{ trans('public.add_file') }}</button>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach ($files as $file)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ trans('update.file_source_' . $file->storage) }}
                                                                    </td>
                                                                    <td>{{ $file->volume }}</td>
                                                                    <td>{{ trans('update.file_type_' . $file->file_type) }}
                                                                    </td>
                                    ...
                                    @if (!empty($webinar) && $webinar->isTextCourse())
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <section class="mt-30 d-none">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddQuiz" type="button"
                                                class="btn btn-primary btn-sm mt-3 d-none">{{ trans('public.add_quiz') }}</button>
                                        </div>
                                        <div class="row mt-10">
                                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish"
                                            class="btn btn-success">{{ !empty($webinar) ? trans('admin/main.save_and_publish') : 'Save and Next Step' }}</button>
