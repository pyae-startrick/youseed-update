                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="full_name" type="text" class="form-control" placeholder="Enter your teacher name" value="{{ request()->get('full_name') }}" list="teachername">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="status" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    <option value="active_verified" @if(request()->get('status') == 'active_verified') selected @endif>Active</option>
