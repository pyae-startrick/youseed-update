                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select multiple name="webinar_id[]" class="form-control search-webinar-select2 @error('webinar_id') is-invalid @enderror" data-placeholder="Search Class">
                                            ...
                                            <div class="form-group mt-4 d-flex align-items-center justify-content-between" style="display: none!important">
