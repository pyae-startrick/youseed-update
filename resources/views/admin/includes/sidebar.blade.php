...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="/">
                ...
                @else
                    Platform Title
                @endif --}}
                <img src="{{ $generalSettings['logo'] }}" style="width:60%;" class="img-cover" alt="site logo">
        ...
        <ul class="sidebar-menu">
            ...
            @if ($authUser->can('admin_webinars') or $authUser->can('admin_categories') or $authUser->can('admin_filters') or $authUser->can('admin_quizzes') or $authUser->can('admin_certificate') or $authUser->can('admin_reviews_lists'))
            ...
            @can('admin_webinars')
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ request()->is('admin/webinars/student') ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/webinars/student">Student Class List</a>
                        </li>
                        <li class="{{ request()->is('admin/webinars/records') ? 'active' : '' }}">
            ...
            @can('admin_quizzes')
                <li class="nav-item dropdown {{ request()->is('admin/quizzes*') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        <li class="{{ request()->is('admin/quizzes/create') ? 'active' : '' }}">
                    ...
                    @endcan
                        ...
                        {{-- @can('admin_certificate_template_list')
                            <li class="{{ request()->is('admin/certificates/templates') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/certificates/templates">Certificate List</a>
                            </li>
                        @endcan --}}
            ...
            @if ($authUser->can('admin_users') or $authUser->can('admin_roles') or $authUser->can('admin_group') or $authUser->can('admin_users_badges') or $authUser->can('admin_become_instructors_list'))
                <li class="menu-header">{{ trans('panel.users') }}</li>
            @endif

            @can('admin_users')
                <li
                    class="nav-item dropdown {{ (request()->is('admin/staffs') or request()->is('admin/students') or request()->is('admin/instructors') or request()->is('admin/organizations') or request()->is('admin/assigned-students') or request()->is('admin/users/create')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ request()->is('admin/assigned-students') ? 'active' : '' }}">
                ...
                <li class="nav-item dropdown {{ request()->is('admin/users/become-instructors*') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        <li class="{{ request()->is('admin/users/become-instructors/instructors') ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/users/become-instructors/instructors"><i
                        ...
                        <li class="{{ request()->is('admin/users/become-instructors/organizations') ? 'active' : '' }}">
                            <a class="nav-link" href="/admin/users/become-instructors/organizations"><i
                                    class="fas fa-list-alt"></i>
            ...
            @if ($authUser->can('admin_supports') or $authUser->can('admin_comments') or $authUser->can('admin_reports') or $authUser->can('admin_contacts') or $authUser->can('admin_noticeboards') or $authUser->can('admin_notifications'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_notifications_posted_list')
                            <li class="{{ request()->is('admin/notifications/posted') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/notifications/posted">{{ trans('admin/main.posted') }}</a>
                            </li>
                        @endcan
            ...
            @if ($authUser->can('admin_blog') or $authUser->can('admin_pages') or $authUser->can('admin_additional_pages') or $authUser->can('admin_testimonials') or $authUser->can('admin_tags') or $authUser->can('admin_regions'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_additional_pages_404')
                            <li class="{{ request()->is('admin/additional_page/404') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/additional_page/404">{{ trans('admin/main.error_404') }}</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_additional_pages_footer')
                            <li class="{{ request()->is('admin/additional_page/footer') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/additional_page/footer">{{ trans('admin/main.footer') }}</a>
                            </li>
                        @endcan()
            ...
            {{-- @if ($authUser->can('admin_documents') or $authUser->can('admin_sales_list') or $authUser->can('admin_payouts') or $authUser->can('admin_offline_payments_list') or $authUser->can('admin_subscribe') or $authUser->can('admin_registration_packages'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_documents_create')
                            <li class="{{ request()->is('admin/financial/documents/new') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/documents/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            {{-- @can('admin_offline_payments_list')
                <li
                    class="nav-item dropdown {{ request()->is('admin/financial/offline_payments*') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_rewards_items')
                            <li class="{{ request()->is('admin/rewards/items') ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/rewards/items">{{ trans('admin/main.items') }}</a>
                            </li>
                        @endcan
            ...
            {{-- @can('admin_registration_packages')
                <li
                    class="nav-item dropdown {{ request()->is('admin/financial/registration-packages*') ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-gem"></i>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_registration_packages_lists')
                            <li class="{{ request()->is('admin/financial/registration-packages') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/registration-packages">{{ trans('admin/main.packages') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_registration_packages_new')
                            <li class="{{ request()->is('admin/financial/registration-packages/new') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/registration-packages/new">{{ trans('admin/main.new_package') }}</a>
                            </li>
                        @endcan

                        @can('admin_registration_packages_reports')
                            <li
                                class="{{ request()->is('admin/financial/registration-packages/reports') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/registration-packages/reports">{{ trans('admin/main.reports') }}</a>
                            </li>
                        @endcan

                        @can('admin_registration_packages_settings')
                            <li
                                class="{{ request()->is('admin/financial/registration-packages/settings') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/registration-packages/settings">{{ trans('admin/main.settings') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @if ($authUser->can('admin_discount_codes') or $authUser->can('admin_product_discount') or $authUser->can('admin_feature_webinars') or $authUser->can('admin_promotion') or $authUser->can('admin_advertising') or $authUser->can('admin_newsletters'))
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_discount_codes_create')
                            <li class="{{ request()->is('admin/financial/discounts/new') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/financial/discounts/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_feature_webinars_create')
                            <li class="{{ request()->is('admin/webinars/features/create') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/webinars/features/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_advertising_banners_create')
                            <li class="{{ request()->is('admin/advertising/banners/new') ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="/admin/advertising/banners/new">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            {{-- @can('admin_referrals')
                <li class="nav-item dropdown {{ request()->is('admin/referrals*') ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        ...
                        <span>{{ trans('admin/main.affiliate') }}</span>
                    </a>
                    <ul class="dropdown-menu">
